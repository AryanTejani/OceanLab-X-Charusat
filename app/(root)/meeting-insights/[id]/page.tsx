...
const MeetingInsightsPage = () => {
  ...
  // Initial load + auto-generate insights if processing
  useEffect(() => {
    const init = async () => {
  ...
  return (
    <section className="flex size-full flex-col gap-6 text-white">
      ...
      {(generating || meeting.status === 'processing') && (
        <div className="flex items-center gap-3 p-4 rounded-lg bg-dark-3 border border-yellow-500/30">
          ...
          <span className="text-yellow-200 text-sm">
            Analyzing meeting transcript... This may take a moment.
          </span>
        </div>
      )}
            ...
            {meeting.podcastStatus === 'ready' && meeting.podcastUrl ? (
              ...
              <div className="rounded-xl bg-dark-3 p-4 border border-dark-4">
                <h3 className="text-sm font-semibold text-white mb-3 flex items-center gap-2">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#0E78F9" strokeWidth="2">
                ...
                <button
                  ...
                  disabled={podcastGenerating || meeting.podcastStatus === 'generating'}
