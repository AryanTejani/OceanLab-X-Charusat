          ...
          >
            {isActive && (
              <motion.div
                ...
                className="absolute inset-0 rounded-full border border-slate-200 border-[#fefefe]/90 bg-gradient-to-b from-[#fefefe] to-gray-50/80 shadow-xs dark:border-neutral-600/50 dark:from-neutral-700 dark:to-neutral-800/90 dark:border-slate-800"
              />
            )}
