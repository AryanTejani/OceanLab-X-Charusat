...
export const InlineToast: FC<InlineCopyToastProps> = ({
  ...
  return (
    <motion.div
      ...
      className="relative flex h-16 min-w-[320px] items-center justify-center overflow-hidden rounded-full border border-slate-200 border-[#ecebeb2b] bg-[#F6F6F6] pl-7 pr-2 shadow-sm dark:bg-zinc-900 dark:border-slate-800"
    >
      <AnimatePresence>
        {copied && (
          <motion.div
