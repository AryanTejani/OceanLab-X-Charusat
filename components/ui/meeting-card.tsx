            ...
            <div className="w-full mt-12 flex flex-col items-center justify-center p-2 sm:p-6 relative bg-transparent"> 
                <div className="w-full max-w-full lg:w-100 lg:max-w-100">
                    <motion.div
                        layout="position" 
                        transition={spring}
                        className="w-full bg-[#F5F5F7] dark:bg-[#161616] border border-slate-200 border-[#E5E5E5] dark:border-white/10 rounded-xl shadow-lg overflow-hidden dark:border-slate-800"
                    >
                        <div
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2 sm:gap-3 shrink-0">
                                ...
                                <motion.div
                                    ...
                                    className="w-8 h-8 rounded-lg border border-slate-200 border-[#E5E5E5] dark:border-white/10 flex items-center justify-center text-[#9CA3AF] dark:border-slate-800"
                                >
                                    <ChevronUp size={18} />
                                </motion.div>
                            </div>
                                        ...
                                        <div className="pt-3 border-t border-[#EFEFEF] dark:border-white/5 space-y-2">
                                            ...
                                            <div className="flex items-center gap-2 flex-wrap">
                                                {participants.map((p, i) => (
                                                    <div key={i} className="flex items-center gap-2 px-2 py-1 bg-[#F5F5F7] dark:bg-white/5 border border-slate-200 border-[#E5E5E5] dark:border-white/10 rounded-full dark:border-slate-800">
                                    ...
                                    <div className="p-3 flex flex-wrap items-center justify-between gap-3 bg-[#F5F5F7] dark:bg-[#161616] border-t dark:border-white/5">
                                        ...
                                        <div className="flex items-center gap-1.5 flex-wrap sm:flex-nowrap">
                                            {['Yes', 'No', 'Maybe'].map((opt) => (
                                                <button
                                                    key={opt}
                                                    className="px-2.5 sm:px-3 py-1 rounded-full border border-slate-200 border-[#E5E5E5] dark:border-white/10 text-[11px] sm:text-[12px] font-medium text-[#374151] dark:text-gray-300 bg-white dark:bg-white/5 active:bg-gray-200 dark:active:bg-white/10 transition-colors dark:border-slate-800"
                                                >
                                                    {opt}
                                                </button>
                                            ))}
