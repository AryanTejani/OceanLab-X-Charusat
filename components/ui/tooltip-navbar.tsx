                      ...
                      >
                        ...
                        {item.hasBadge && (
                          <div className="flex items-center gap-0.5 text-white/40">
                            <span className="flex items-center justify-center rounded-sm border border-slate-200 border-white/20 p-1 dark:border-slate-800">
                        ...
                        {item.labelHasKeyword && (
                          <div className="flex items-center gap-0.5 text-white/40">
                            {item.labelHasKeyword.map((key, i) => (
                              <span
                                key={i}
                                className="flex items-center justify-center rounded-sm border border-slate-200 border-white/20 px-1 tabular-nums dark:border-slate-800"
                              >
                                {key}
                              </span>
                            ))}
