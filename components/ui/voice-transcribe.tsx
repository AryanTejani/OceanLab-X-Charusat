    ...
    const getCharStyle = (i: number): React.CSSProperties | null => {
        ...
        if (distFromFrontier <= fadeZone) {
            ...
            return {
                ...
                display: 'inline',
                transition: 'opacity 0.07s ease-out, filter ease-out',
            };
        }
    ...
    return (
        <div className={`w-full flex flex-col items-center justify-center p-2 sm:p-4 antialiased select-none ${className}`}>
            <div className="relative flex items-center gap-2 sm:gap-4 w-full max-w-fit">
                ...
                {/* Main Player Pill */}
                <div className="flex items-center gap-2 sm:gap-3 rounded-full px-3 sm:px-4 py-2 sm:py-3 shadow-sm transition-colors bg-neutral-100 dark:bg-neutral-800 border border-slate-200 border-black/5 dark:border-white/5 dark:border-slate-800">
                    <button
                        ...
                        >
                            <div className="relative">
                                <motion.div
                                    ...
                                    className="rounded-2xl sm:rounded-[28px] px-4 py-4 sm:px-6 sm:py-5 w-[calc(100vw-5rem)] max-w-60 sm:max-w-70 shadow-xl border border-slate-200 bg-neutral-50 dark:bg-neutral-800 border-neutral-200 dark:border-white/10 overflow-hidden dark:border-slate-800"
                                >
